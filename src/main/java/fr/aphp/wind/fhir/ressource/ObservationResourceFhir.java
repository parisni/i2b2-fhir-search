...
public class ObservationResourceFhir extends AbstractResourceFhir {

	public ObservationResourceFhir(ConfigFhirApi configApi, ConfigFhirQuery configQuery, ConfigFhirResult configResult) {
